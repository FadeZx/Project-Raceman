...
class CameraOrbitGamepad : public raceman::IObjectScript {
public:
    RACEMAN_SCRIPT_FIELDS_BEGIN()
        RACEMAN_SCRIPT_FIELD_VEC3("targetPosition", "Orbit Center", glm::vec3(0.0f)),
        RACEMAN_SCRIPT_FIELD_FLOAT("stickYawSpeed", "Stick Yaw Speed (deg/s)", 140.0f),
        RACEMAN_SCRIPT_FIELD_FLOAT("stickPitchSpeed", "Stick Pitch Speed (deg/s)", 110.0f),
        ...
        RACEMAN_SCRIPT_FIELD_BOOL("invertY", "Invert Stick Y", false),
        RACEMAN_SCRIPT_FIELD_BOOL("allowMouse", "Allow Mouse Drag", true)
